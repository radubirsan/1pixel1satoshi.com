...
function Editor(canvas, gridCanvas, toolCanvas) {
	...
	this.gridSize = Math.ceil(1000/this.pixelSize);
...
console.log("drawPixel", pos[0], pos[1])
		if(this.pixelArray[pos[0]][pos[1]] == 0)
		{
			newPixel++;
			console.log("new pixel", newPixel , color, this.pixelArray[pos[0]][pos[1]])
...
$('#save-art-title').html("Send exactily" + newPixel + "satoshis to this addess:<br/>bc1qjl8uwezzlech723lpnyuza0h2cdkvxvh54v3dn");
